...
public final class AsyncGuard {
    // Kept for upgrade safety: loading AsyncGuard together with an old AsyncSableFix JAR
    // must fail as a duplicate mod instead of applying the same mixins twice.
    public static final String MOD_ID = "asyncsablefix";

    public AsyncGuard() {
        System.out.println("[AsyncGuard] Loaded 0.2.0: Async compatibility/thread-safety guards active.");
    }
}
